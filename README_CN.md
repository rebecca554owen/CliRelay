...
<p align="center">
  ...
  <a href="https://github.com/rebecca554owen/codeProxy">🖥️ 管理面板</a> ·
...
> 🔗 面板资源仓库可通过 `remote-management.panel-github-repository` 配置，默认仓库为 [rebecca554owen/codeProxy](https://github.com/rebecca554owen/codeProxy)。
...
- 面板的 UI/交互/文案 等改动请到面板源码仓库（默认 `rebecca554owen/codeProxy`）提交，并通过其发布产物（GitHub Release）供服务端拉取。
